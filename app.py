    ...
    with tabs[0]:  
        if st.session_state['current_channel'] == "":  
            ...
            if barcode_input:
                ...
                alert_group1 = ["4710155288739", "4710155287558"]
                alert_group2 = ["4710155284779", "4710155285837", "4710155281877", "4710155274527"]
                alert_group3 = ["4710155282249", "4710155277528", "4710155279522", "4710155277573", 
                                "4710155282188", "4710155285653", "4710155285912", "4710155278921", 
                                "4710155282386", "4710155278860"]

                if barcode_input in alert_group1:
                    st.warning("⚠️ 提醒：勿拆成單品單件")
                if barcode_input in alert_group2:
                    st.warning("⚠️ 提醒：請額外裝箱並貼上大字報（好壞品分開放）")
                if barcode_input in alert_group3:
                    st.warning("⚠️ 提醒：需退回工廠商品，請額外裝箱並貼上大字報（好壞品分開放）")
